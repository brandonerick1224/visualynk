(function () {
    ...
    angular.module('app').controller(controllerId,
        ['$rootScope','$scope', '$compile','common', 'config','$route','UserService','$http','$window','$element', model3d]);

    function model3d($rootScope,$scope, $compile, common, config ,route,UserService,$http,$window,$element) {
        ...
        angular.element('object.svg').each(function(){
            ...
            jQuery.get(imgURL, function(data) {
                ...
                $('g>g>path').click(function() {
                    ...
                    $('.selected').attr('style','fill:#2ECC71; stroke-width:2; stroke:black; opacity:0.7');
